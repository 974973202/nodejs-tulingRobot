...
http.createServer(function(request, response) {
    ...
    if (is) {//如果是静态文件，执行这个部分
        try {//能找到页面，返回页面的数据
            var data = fs.readFileSync("../nodejs-tulingRobot/page" + pathname);
        ...
        if (pathname == "/api/chat") {
            ...
            var params = url.parse(request.url, true).query;  // 请求解析为对象
            var data = {
                "reqType":0,
                "perception": {
                    "inputText": {
                ...
                "userInfo": {
                    "apiKey": "efadf34d1de14c89845a665bb29ba451",
                    "userId": "123456"
                }
            }
            ...
            req({
                ...
                body: contents
            }, function (error, resp, body) {  // err  响应  数据
...
function isStaticFile(pathname) {
    var staticFile = [".html", ".css", ".js", ".jpg", ".jpeg", ".png", ".gif", ".ico"];
